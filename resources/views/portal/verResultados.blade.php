            ...
            @if ($facturas)
                ...
                <tr class="text-center">
                    ...
                    <td class="px-4 py-2 border border-blue-300">
                        <a style="text-decoration:underline; color:rgba(63,131,248)" href="{{ route('archivosDown', $factura->pdf) }}" target="_blank">{{ $factura->pdf }} 
                            <br><br>
                            <button class="custom-button" type="button">Descargar</button>
                        </a>
                    </td>
                    <td class="px-4 py-2 border border-blue-300">
                        <a style="text-decoration:underline; color:rgba(63,131,248)" href="{{asset ('uploads_xml/'. $factura->xml )}}" target="_blank">{{ $factura->xml }}
                            <br>
                            <button class="custom-button" type="button">Descargar</button>
                        </a>
                    </td>
