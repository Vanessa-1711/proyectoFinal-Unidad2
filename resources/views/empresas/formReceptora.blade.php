...
@section('titulo2')
    <div class="bg-gradient-to-r from-purple-100 to-pink-300 p-4 text-center">
        <h2 class="text-3xl font-extrabold text-blak">AGREGAR EMPRESA RECEPTORA</h2>
    </div>
@endsection
...
<div class="md:flex md:justify-center md:gap-10 md:items-center">
    <div class="md:w-6/12 p-5">
        ...
        <img src="{{asset('img/1.png')}}" alt="Imagen login de usuarios">
    </div>
    <div class="w-9/12 lg:w-4/12 bg-white p-6 rounded-lg shadow-xl">
        ...
        <form method="POST" action="" novalidate>
            ...
            <div class="mb-5">
                ...
                <input id="direccion" name="direccion" type="text" placeholder="Direccion" class="border p-3 w-full rounded-lg @error('direccion') border-red-500 @enderror" value="{{old('direccion')}}">
                @error('direccion')
                    <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{$message}}</p>
                @enderror
            </div>
